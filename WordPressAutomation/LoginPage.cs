...
namespace SophiaFioriAutomation
{
    public class LoginPage
    {
        ...
        {
            Driver.Instance.Navigate().GoToUrl("http://sophiafiori.azurewebsites.net/#/contacts");
        }
    ...
    public class LoginCommand
    {
        ...
        public void Login()
        {
            ...
            var loginButton = Driver.Instance.FindElement(By.XPath("//button[contains(.,'Login')]"));
           loginButton.Click();
        }
    }
}
